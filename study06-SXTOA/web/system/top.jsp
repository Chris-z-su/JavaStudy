...
<html>
	...
	<body style="background:url(images/topbg.gif) repeat-x;">
	    ...
	    <div class="topleft">
	    <a href="system/main.jsp" target="_parent"><img src="images/logo.png" title="系统首页" /></a>
	    </div>
	    ...
	    <li><a href="loginServlet.bjsxt?method=loginout" target="_parent">退出</a></li>
	    </ul>
	     
	    <div class="user">
	    	<span><a href="myInfo.html" target="rightFrame" onclick="selectempbyempid('${employee.empid }')">${emp.realname }</a></span>
	    </div>    
