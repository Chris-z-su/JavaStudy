...
<link href="css/style.css" rel="stylesheet" type="text/css" />
	...
	<body>
		...
		<div class="formbody">
			...
			<form method="post" action="employeeServlet.bjsxt?method=insertemp">
				<ul class="forminfo">
					<li>
						<label>用户名</label><!-- placeholder="username" -->
						<input name="empid" type="text" class="dfinput" /><i></i>
					</li>
					<li>
						<label>真实姓名</label>
						<input name="realname" type="text" class="dfinput" /><i></i>
					</li>
					<li>
						<label>性别</label>
						<cite>
					...
					<li>
						<label>出生日期</label><!--  onfocus="WdatePicker({skin:'whyGreen',lang:'en'})" -->
						<input name="birthdate" type="text" class="dfinput" onfocus="WdatePicker()" /><i>也可以根据身份证号自动获取</i>
					</li>
					<li>
						<label>入职时间</label>
						<input name="hiredate" type="text" class="dfinput" onfocus="WdatePicker()"/><i></i>
					</li>
					<li>
						<label>离职时间</label>
						<input name="leavedate" type="text" class="dfinput" onfocus="WdatePicker()"/><i></i>
					</li>
					<li>
						<label>是否在职</label>
						<cite>
