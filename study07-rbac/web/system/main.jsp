...
<frameset rows="88,*,31" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset cols="187,*" frameborder="no" border="0" framespacing="0">
    ...
    <frame src="system/right.jsp" name="rightFrame" id="rightFrame" title="rightFrame" />
  </frameset>
  <frame src="system/footer.jsp" name="bottomFrame" scrolling="No" noresize="noresize" id="bottomFrame" title="bottomFrame" />
</frameset>
<noframes><body>
</body></noframes>
</html>
